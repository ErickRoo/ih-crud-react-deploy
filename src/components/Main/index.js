...
export default function Main() {
  ...
  const handleInputs = (event) => {
    ...
    //[event.target.name] está en corchetes porque entramos a multiples resultados de una propiedad de un objeto
    setPost({
      ...post,
      id: nanoid(),
    ...
    <>
      <div className="max-w-7xl mx-auto px-12 pt-12">
        ...
        >
          ...
          <label for="titulo" className="block text-sm font-medium text-gray-700">Título</label>
          <div className="mt-1">
            <input
              type="text"
              name="titulo"
          ...
          <label for="contenido" className="block text-sm font-medium text-gray-700">Contenido</label>
          <div className="mt-1">
            <input
              type="text"
              name="contenido"
              className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md mb-6" placeholder="Escribe tu contenido..."
              onChange={(event) => { handleInputs(event) }}
        ...
        <h1 className="text-4xl font-extrabold text-gray-900 mt-12 sm:text-5xl sm:tracking-tight lg:text-6xl">Publicaciones</h1>

        <ul role="list" className="divide-y divide-gray-200 mt-12">
                  ...
                  <>
                    <li className="bg-white py-5 px-4 hover:bg-gray-50 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                      <div className="flex justify-between space-x-3">
                        <div className="min-w-0 flex-1 block focus:outline-none">
